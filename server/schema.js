...
CREATE INDEX idx_replies_create_date ON replies(create_date) STORING (parent_topic_id, parent_reply_id, body, note, user_id, favorite_count, counts_max_create_date)
CREATE INDEX idx_replies_parent_reply_id ON replies(parent_reply_id)
CREATE INDEX idx_replies_parent_topic_id ON replies(parent_topic_id) STORING (user_id)
...
CREATE INDEX idx_replies_parent_topic_id_parent_reply_id_user_id ON replies (parent_topic_id, parent_reply_id, user_id) STORING (body, note, create_date, favorite_count, counts_max_create_date)
...
CREATE INDEX idx_favorites_posts_user_id ON favorite_posts(user_id) STORING (topic_id)
CREATE INDEX idx_favorites_posts_topic_id ON favorite_posts(topic_id) STORING (user_id)
...
CREATE INDEX idx_flagged_posts_topic_id ON flagged_posts(topic_id)
