...
poll_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
topic_id INT NOT NULL,
text_a VARCHAR(50),
count_a INT DEFAULT 0,
count_a_estimated INT DEFAULT 0,
text_b VARCHAR(50),
count_b INT DEFAULT 0,
count_b_estimated INT DEFAULT 0,
text_c VARCHAR(50),
count_c INT DEFAULT 0,
count_c_estimated INT DEFAULT 0,
text_d VARCHAR(50),
count_d INT DEFAULT 0,
count_d_estimated INT DEFAULT 0,
...
user_id INT NOT NULL,
option INT NOT NULL CHECK (option BETWEEN 1 AND 4),
create_date TIMESTAMP(3) NOT NULL DEFAULT NOW()
);
