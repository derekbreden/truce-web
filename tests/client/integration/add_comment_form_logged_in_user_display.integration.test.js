...
const tests = {
    testLoggedInUserSeesDisplayNamePrefilledInAddCommentForm: async () => {
        ...
        assertEquals(true, Boolean($topicLinkElement), `Topics page: Clickable topic titled '${mockTopic.title}' should be found.`)
        ...
        assertEquals(mockUser.display_name + ":", $displayNameText.innerText.trim(), `Add comment form: Display name should be '${mockUser.display_name}:'. Actual: '${$displayNameText.innerText.trim()}'`)
        ...
        assertEquals("Comment", $bodyTextarea.getAttribute("placeholder"), "Body textarea placeholder should be 'Comment'.")
        ...
        assertEquals("Add comment", $submitButton.innerText.trim(), "Submit button text should be 'Add comment'.")
        ...
        assertEquals("Cancel", $cancelButton.innerText.trim(), "Cancel button text should be 'Cancel'.")
    }
}
