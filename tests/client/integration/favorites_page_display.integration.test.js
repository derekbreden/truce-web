...
const tests = {
    ...
    testFavoritesPageDisplayWithActivities: async () => {
        ...
        const $activitiesContainer1WithData = $("main-content-wrapper[active] main-content activities");
        assertEquals(true, Boolean($activitiesContainer1WithData), "Activities container should exist after loading data.");

        // Assertions for the comment activity (should appear first due to create_date)
        const $commentActivity = $activitiesContainer1WithData.$("activity[comment]");
        ...
        const $activitiesContainer2WithData = $("main-content-wrapper[active] main-content-2 activities");
        assertEquals(true, Boolean($activitiesContainer1WithData), "Activities container should exist after loading data.");
