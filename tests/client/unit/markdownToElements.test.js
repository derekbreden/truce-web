...
function testParagraphs() {
    ...
    assertEquals(spanActual.textContent, "Hello world", "Paragraph test: span textContent");
    ...
    assertEquals(span1Actual.textContent, "Line 1", "Multi-paragraph test: span1 textContent");
    ...
    assertEquals(span2Actual.textContent, "Line 2", "Multi-paragraph test: span2 textContent");
}
...
function testBlockquotes() {
    ...
    assertEquals(spanActual.textContent, "This is a quote", "Blockquote test: span textContent");
}
...
function testHeaders() {
    ...
    assertEquals(spanActual.textContent, "Heading 1", "Header test: span textContent");
}
...
function testBold() {
    ...
    assertEquals(spanActual.textContent, "bold text", "Bold test: span textContent");
}
...
function testItalic() {
    ...
    assertEquals(spanActual.textContent, "italic text", "Italic test: span textContent");
}
...
function testUnorderedList() {
    ...
    assertEquals(li1Actual.textContent, "item 1", "Unordered List test: li1 textContent");
    ...
    assertEquals(li2Actual.textContent, "item 2", "Unordered List test: li2 textContent");
}
...
function testOrderedList() {
    ...
    assertEquals(li1Actual.textContent, "item 1", "Ordered List test: li1 textContent");
    ...
    assertEquals(li2Actual.textContent, "item 2", "Ordered List test: li2 textContent");
}
...
function testImages() {
    ...
    assertEquals(span1Actual.textContent, "Text before ", "Image mixed content test: span1 textContent");
    ...
    assertEquals(span2Actual.textContent, " text after", "Image mixed content test: span2 textContent");
}
...
function testLinks() {
    ...
    assertEquals(aActual.textContent, "link text", "Link test: a textContent");
    ...
    assertEquals(span1Actual.textContent, "Text before ", "Link mixed content test: span1 textContent");
    ...
    assertEquals(a2Actual.textContent, "link2", "Link mixed content test: a2 textContent");

    const span2Actual = pMixedActual.children[2];
    assertEquals(span2Actual.tagName, "SPAN", "Link mixed content test: span2 tagName");
    assertEquals(span2Actual.textContent, " text after", "Link mixed content test: span2 textContent");
}
...
function testAutomaticUrlLinking() {
    ...
    assertEquals(span1Actual.textContent, "Check ", "Auto URL test: span1 textContent");
    ...
    assertEquals(aActual.textContent, "example.com", "Auto URL test: a textContent");

    const span2Actual = pActual.children[2];
    assertEquals(span2Actual.tagName, "SPAN", "Auto URL test: span2 tagName");
    assertEquals(span2Actual.textContent, " out", "Auto URL test: span2 textContent");
}
