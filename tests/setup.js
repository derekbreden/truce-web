...
const original_session_uuid = localStorage.getItem(`${window.local_storage_key}:session_uuid`);
if (test_mode === "record") {
...
const testCleanup = () => {
  localStorage.setItem(`${window.local_storage_key}:session_uuid`, original_session_uuid);
